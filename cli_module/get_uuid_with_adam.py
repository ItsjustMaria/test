...
def main(env, street_uuids):
                ...
                "queries": [
                    {
                        "queries": [
                            ...
                            },
                            {
                                "type": "FieldQuery",
                                "operator": "notEmpty",
                                "field": "Deed.saa:isAssociatedWithHistoricalAddress1853.saa:hasOrHadHistoricalAddress1853SubjectLocation",
                                "value": ""
                            }
                        ],
                        "type": "AndQuery"
    ...
    # Write UUIDs to CSV
    # ---------------------------
    with open(street_uuids, "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
