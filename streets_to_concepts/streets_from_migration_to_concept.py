...
# Bestandspaden
turtle = "../template/deed.ttl"       # <-- Zet hier het pad naar jouw Turtle file
excel_file = "test_straten.xlsx"       # <-- Zet hier de gewenste Excel naam

options = {
            "turtle": turtle,  ## Okay think! You need to do WHAT? Get info from memorix
            "headers": {
...
response = api.get_record_type( 'Deed', options)
